...
_0x0:
	.DB  0x24,0x25,0x31,0x64,0x2C,0x25,0x31,0x64
	.DB  0xA,0xD,0x0
...
; 0000 0102         read_curr1=read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	LDI  R26,LOW(_read_curr1)
	LDI  R27,HIGH(_read_curr1)
	RJMP _0x2060001
...
; 0000 0107         read_curr2=read_adc(2);
	LDI  R26,LOW(2)
	RCALL _read_adc
	LDI  R26,LOW(_read_curr2)
	LDI  R27,HIGH(_read_curr2)
_0x2060001:
	CLR  R22
	CLR  R23
	CALL __CDF1
...
; 0000 0266             read_current1();
	RCALL _read_current1
; 0000 0267             read_current2();
	RCALL _read_current2
; 0000 0268             printf("$%1d,%1d\n\r",read_current1,read_current2);
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	LDI  R30,LOW(_read_current1)
	LDI  R31,HIGH(_read_current1)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDI  R30,LOW(_read_current2)
	LDI  R31,HIGH(_read_current2)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDI  R24,8
