...
return adc_data;
    ...
    void read_current1()
    {
        read_curr1=read_adc(1);
        delay_ms(10);
    }
    void read_current2()
    {
        read_curr2=read_adc(2);
        delay_ms(10);
    }
...
// Timer Period: 0.27669 ms
// Output Pulse(s):
// OC2B Period: 0.27669 ms Width: 0 us
ASSR=(0<<EXCLK) | (0<<AS2);
...
// Timer Period: 0.27669 ms
// Output Pulse(s):
// OC4A Period: 0.27669 ms Width: 0 us// OC4B Period: 0.27669 ms Width: 0 us// OC4C Period: 0.27669 ms Width: 0 us
...
TCCR4B=(0<<ICNC4) | (0<<ICES4) | (0<<WGM43) | (0<<WGM42) | (0<<CS42) | (1<<CS41) | (0<<CS40);
TCNT4H=0x00;
TCNT4L=0x00;
ICR4H=0x00;
ICR4L=0x00;
...
// PCINT16 interrupt: On
// PCINT17 interrupt: On
// PCINT18 interrupt: On
// PCINT19 interrupt: On
// PCINT20 interrupt: On
// PCINT21 interrupt: On
// PCINT22 interrupt: On
// PCINT23 interrupt: On
